...
export const COPY: Record<string, any> = {
  en: {
    ...
    email: "And your email? You get your confirmation there and it creates your Massage Club account. Reply *skip* if you prefer not to.",
    emailBad: "That does not look like an email. Try again, or reply *skip*.",
    emailAskPost: "One more thing: want this confirmation by email, plus your bookings saved so next time takes one tap? Reply with your email and your free account is ready. Reply *skip* if not.",
  ...
  es: {
    ...
    email: "¿Y tu email? Ahí te llega la confirmación y crea tu cuenta de Massage Club. Responde *saltar* si prefieres no darlo.",
    emailBad: "Eso no parece un email. Prueba otra vez, o responde *saltar*.",
    emailAskPost: "Una cosa más: ¿quieres la confirmación por email y tus reservas guardadas para repetir en un toque? Responde con tu email y tu cuenta gratis queda lista. Responde *saltar* si no.",
