...
export default function WhatsAppBubble() {
  ...
  const message = studio
    ? es
      ? `Hola Massage Club! Tengo una pregunta sobre ${studio}.`
      : `Hi Massage Club! I have a question about ${studio}.`
    : es
      ? "Hola Massage Club! Quiero ayuda para reservar un masaje."
      : "Hi Massage Club! I'd like help booking a massage.";
  const href = conciergeWhatsappUrl(message);
